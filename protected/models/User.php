...
class User extends CActiveRecord {
    ...
    public function rules() {
        return array(
            ...
            array('email, password, role, name, contact_name, phone, note, registration_code, recover_password, new_pass', 'length', 'max' => 255),
    ...
    public function attributeLabels() {
        return array(
            ...
            'new_pass' => Yii::t("translation", "new_pass"),
        );
    }
    ...
    public function getTeamId() {
        ...
        $models = TeamName::model()->findAll($criteria);
    ...
    public function getRole() {
        return array(
            ...
            'moderator' => Yii::t("translation", "moderator"),
    ...
    public function getMyTeamUsers() {
        $user_model = self::model()->findByPk(Yii::app()->user->id);
        $models = self::model()->findAllByAttributes(array('team_id' => $user_model->team_id));
//        $array = NULL;
