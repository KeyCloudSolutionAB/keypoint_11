...
class DefaultController extends Controller {
    ...
    public function actionFilters() {
        ...
        if (isset($_POST['reset_all'])) {
            $all = FilterScorlist::model()->deleteAllByAttributes(array('user_id' => Yii::app()->user->id));
            $all = FilterCategory::model()->deleteAllByAttributes(array('user_id' => Yii::app()->user->id));
            $all = FilterTags::model()->deleteAllByAttributes(array('user_id' => Yii::app()->user->id));
    ...
    public function actionIndex() {
        ...
        $filter_scorlist = FilterScorlist::model()->checkScorings(Yii::app()->user->id);
        ...
        // 
        $filter_category = FilterCategory::model()->checkCategories(Yii::app()->user->id);
        ...
        // 
        $filter_tag = FilterTags::model()->checkTags(Yii::app()->user->id);
        if (!empty($filter_tag)) {
            foreach ($models as $key => $value) {
