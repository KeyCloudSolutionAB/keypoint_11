    ...
    <div class="col-lg-12">     
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php echo CHtml::link(Yii::t("translation", "delete_customer_base"), array('settings/index', 'key' => $uniq), array('class' => 'btn btn-default')); ?>
                <?php echo CHtml::link(Yii::t("translation", "share_dashboard"), array('dashboard/index'), array('class' => 'btn btn-default')); ?>
                <?php echo CHtml::link(Yii::t("translation", "delete_all_article"), array('settings/articles', 'key' => $uniq), array('class' => 'btn btn-default')); ?>
            </div>           
        </div>
    </div>
</div>