    ...
    <div class="col-lg-12">
        <div class="panel panel-default">                          
            <div class="panel-body">                 
                <?php echo CHtml::link('<i class="fa fa-arrow-left"></i>', array('default/view', 'id' => $model->id), array('class' => 'btn btn-default')); ?>  
                <?php echo CHtml::link('<i class="fa fa-arrow-right"></i>', array('default/top', 'id' => $model->id), array('class' => 'btn btn-default')); ?>  
            </div>                            
        </div>                       
        <div class="panel panel-default">
