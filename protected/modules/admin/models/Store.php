...
//            'condition' => "lang='" . Yii::app()->language . "'",
            'condition' => "store.user_id='" . Yii::app()->params['choose_customer'] . "'",
        );
    }
    ...
    protected function beforeDelete() {
        ...
        // ! Здесь будем удалать comment
        //
        $total_scorings = TotalScoring::model()->resetScope()->findAllByAttributes(array('store_id' => $this->id));
        if (!empty($total_scorings)) {
