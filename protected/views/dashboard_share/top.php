    ...
    <div class="col-lg-12">
        <div class="panel panel-default">                          
            <div class="panel-body">
                <?php
                if (!empty($model)) {
                    echo CHtml::link('<i class="fa fa-arrow-left"></i>', array('dashboard_share/image', 'id' => $model->id, 'key_id' => $model_dash->key), array('class' => 'btn btn-default'));
                } else {
                    echo CHtml::link('<i class="fa fa-arrow-left"></i>', array('dashboard_share/index', 'key_id' => $model_dash->key), array('class' => 'btn btn-default'));
                }
                ?>  
            </div>                            
        </div>                       
