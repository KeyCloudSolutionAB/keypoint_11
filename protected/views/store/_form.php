...
<div class="form-group">
    ...
    <?php echo $form->dropDownList($model, 'store_category_id', $model->StoreCategoryId, array('class' => 'form-control')); ?>   
    <?php echo $form->error($model, 'store_category_id'); ?>
</div>

<div class="form-group">
    <?php echo $form->labelEx($model, 'sellers'); ?>
    <?php echo $form->textField($model, 'sellers', array('class' => 'form-control')); ?>
