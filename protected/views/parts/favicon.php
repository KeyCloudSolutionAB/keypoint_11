<!--<link rel="shortcut icon" href="<?php // echo Yii::app()->request->baseUrl; ?>/favicon/favicon-32x32.png" type="image/x-icon">-->
...
<!--<link rel="manifest" href="<?php // echo Yii::app()->request->baseUrl; ?>/favicon/manifest.json">-->
<meta name="msapplication-TileColor" content="#ffffff">
<meta name="msapplication-TileImage" content="<?php echo Yii::app()->request->baseUrl; ?>/favicon/ms-icon-144x144.png">
