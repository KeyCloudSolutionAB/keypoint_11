...
<html lang="en">
    <head>
        ...
        <title><?php echo Yii::app()->name; ?> - <?php echo Yii::t("translation", "lost_my_password"); ?></title>
                        ...
                        <div class="panel panel-default">                             
                            ...
                            <div class="panel-body">
                                ...
                                $form = $this->beginWidget('CActiveForm', array(
                                    'id' => 'lost-password-form-password-form',
                                ...
                                <fieldset>
                                    <div class="form-group">                                        
                                        <?php echo $form->textField($model, 'email', array('class' => 'form-control', 'placeholder' => Yii::t("translation", "email"))); ?>
                                    ...
                                    <?php echo CHtml::submitButton(Yii::t("translation", "restore_password"), array('class' => 'btn btn-success')); ?>
                                    <?php echo CHtml::link(Yii::t("translation", "sign_in"), array('login/index'), array('class' => 'btn btn-default')); ?>
                                </fieldset>
                                <?php $this->endWidget(); ?>                              
                            </div>
